...
"""Task22: From a list of movies find those who start with the letter G. """
movies =['Star Wars', 'Gandhi', 'Casablanca', 'Toy Story', 'Matrix', 'Lord of The Rings',
         'Gone with the Wind', 'Citizen Kane', "It's a Wonderful Life", 'The Wizard of Oz']
def movies_starting_with_G(list):
    # Version 1
    # gmovies = []
    # for title in movies:
    ...
    return [title for title in movies if title.startswith("G")]


"""Task23: Find movies released before 2000 from a list with movie names and year released. """
movies2 = [('Star Wars', 1943), ('Gandhi', 1924), ('Casablanca', 1999), ('The Wizard of Oz', 2000),
           ('Toy Story', 1950), ('Matrix', 2004), ('Lord of The Rings', 1960),
           ('Gone with the Wind', 1949), ('Citizen Kane', 1690)]
def pre2k_movies(list):
    pre2k = [title for (title, year) in list if year < 2000]
    return pre2k


"""Task24: Multiply the elements of the vector by 4. """
v = [2, -3, 1]
def multiply_vector(list):
    return [x*4 for x in list]
    # 4v = 4*list - This does NOT WORK
...
def main():
    ...
    print("Task22: From a list of movies find those who start with the letter G. ")
    print(movies_starting_with_G(movies), "\n")

    print('Task23: Find movies released before 2000 from a list with movie names and year released.')
    print(pre2k_movies(movies2))
    print("Task24: Multiply the elements of the vector by 4. ")
    print(multiply_vector(v), "\n")

    print("Task25: Calculate the cartesian (cross) product of the 2 lists. ")
